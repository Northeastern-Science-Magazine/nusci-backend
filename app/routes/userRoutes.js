...
router.route("/email/:email").get(UserController.getPublicUserByEmail); //get a single user by email
...
router.route("/update/:email"); //admin update of a user including adding + removing roles
