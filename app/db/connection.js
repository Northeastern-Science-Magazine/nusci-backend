...
export default class Connection {
  ...
  static async open(silentLog) {
    ...
    if (!connection) {
      ...
      const { MONGODB_INITDB_ROOT_EMAIL, MONGODB_INITDB_ROOT_PASSWORD, MONGODB_INITDB_HOSTNAME, MONGODB_INITDB_PORT } =
        process.env;
      const DATABASE_URL = `mongodb://${MONGODB_INITDB_ROOT_EMAIL}:${MONGODB_INITDB_ROOT_PASSWORD}@${MONGODB_INITDB_HOSTNAME}:${MONGODB_INITDB_PORT}`;
