export default [
    ...
    comments: [
      {
        ...
        body: "Fascinating read! AI's impact on society is both exciting and daunting.",
      },
      {
        author: "Sophie",
        date: new Date("2024-04-01"),
        body: "This article raises important questions about the future of AI ethics and governance.",
      },
    ],
    theme: "Technology",
  ...
  },
  {
    ...
    images: ["url1.com", "url2.com"],
    body: [
      "Three decades later, Sweess looks back on the moments that have defined his path to notoriety.",
    ...
    pullquotes: [
      ...
      "Sweess' achievements would go on to define the modern tech industry as we know it today.",
    ],
    ...
    comments: [
      {
        ...
        body: "Great article! Sweess inspired me to become a computer scientist!",
      },
      {
        author: "Rebecca",
        date: new Date("2024-03-29"),
        body: "This guy's a yapper",
      },
    ],
    theme: "Technology",
    elementOrder: ["body", "pull", "body", "pull", "body"],
    ...
    comments: [
      {
        ...
        body: "This was a very interesting article.",
      },
      {
        author: "Arushi",
        date: new Date("2024-03-27"),
        body: "Certainly one of the most articles out there.",
      },
    ],
    theme: "Health",
    elementOrder: ["body", "pull", "body", "pull", "body"],
