...
export default [
  {
    ...
    editors: [new mongoose.Types.ObjectId("b00000000000000000000005"), new mongoose.Types.ObjectId("b00000000000000000000006")],
  ...
  },
  {
    ...
    articleContent: [
      ...
      {
        contentType: ArticleContent.PullQuote.type,
        content: "Sweess' rapid rise is a success story in the tech industry, but the journey for him started at Northeastern.",
      },
      {
        contentType: ArticleContent.BodyParagraph.type,
